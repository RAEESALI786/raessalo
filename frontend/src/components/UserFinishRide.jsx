  ...
  return (
    <div className='h-screen'>
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        }} className="flex w-full  justify-center mt-5 bg-green-600 text-white font-semibold rounded-xl p-3">
          Payment
        </button>

        <p className="text-red-500 mt-6 text-xs">Click on payment button only if you have completed the ride.</p>
